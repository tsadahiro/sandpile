...
var $author$project$Square$n = 200;
...
var $author$project$Square$initialConf = $elm$core$Array$fromList(
	A2(
		$elm$core$List$repeat,
		$author$project$Square$n,
		$elm$core$Array$fromList(
			A2($elm$core$List$repeat, $author$project$Square$n, 0))));
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Square$init = function (_v0) {
	return _Utils_Tuple2(
		{conf: $author$project$Square$initialConf},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Square$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Square$subscriptions = function (model) {
	return A2($elm$time$Time$every, 1, $author$project$Square$Tick);
};
...
var $author$project$Square$confAdd = F4(
	function (i, j, x, conf) {
		var row = A2(
			$elm$core$Maybe$withDefault,
			$elm$core$Array$fromList(_List_Nil),
			A2($elm$core$Array$get, i, conf));
		var el = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Array$get, j, row));
		return A3(
			$elm$core$Array$set,
			i,
			A3($elm$core$Array$set, j, el + x, row),
			conf);
	});
...
var $author$project$Square$fire = F3(
	function (i, j, conf) {
		var x = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
				...
				A2(
					...
					$elm$core$Array$fromList(_List_Nil),
					A2($elm$core$Array$get, i, conf))));
		var y = (x > 3) ? (((x - A2($elm$core$Basics$modBy, 4, x)) / 4) | 0) : 0;
		var neighbors = $elm$core$List$concat(
			_List_fromArray(
				[
					(i > 0) ? _List_fromArray(
					[
					...
					(_Utils_cmp(i, $author$project$Square$n - 1) < 0) ? _List_fromArray(
					[
						{i: i + 1, j: j}
					]) : _List_Nil,
					(j > 0) ? _List_fromArray(
					...
					(_Utils_cmp(j, $author$project$Square$n - 1) < 0) ? _List_fromArray(
					[
						{i: i, j: j + 1}
					]) : _List_Nil
				]));
		return (y > 0) ? A4(
			$author$project$Square$confAdd,
			i,
			j,
			(-4) * y,
			A3(
				...
				F2(
					function (nei, arr) {
						return A4($author$project$Square$confAdd, nei.i, nei.j, y, arr);
					}),
				conf,
				neighbors)) : conf;
	});
var $author$project$Square$fireAll = function (conf) {
	var indices = A2($elm$core$List$range, 0, $author$project$Square$n - 1);
	return A3(
		$elm$core$List$foldl,
		F2(
			function (i, c) {
				return A3(
					...
					F2(
						function (j, d) {
							return A3($author$project$Square$fire, i, j, d);
						}),
					c,
					indices);
			}),
...
var $author$project$Square$stable = function (conf) {
	var confList = $elm$core$List$concat(
	...
	return 3 >= A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$List$maximum(confList));
};
var $author$project$Square$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'CanvasClick':
			...
			case 'Tick':
				var t = msg.a;
				if ($author$project$Square$stable(model.conf)) {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var dummy = A2($elm$core$Debug$log, 'update', 'update');
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								conf: $author$project$Square$fireAll(model.conf)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							conf: A4($author$project$Square$confAdd, ($author$project$Square$n / 2) | 0, ($author$project$Square$n / 2) | 0, num, model.conf)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Square$AddToOrigin = function (a) {
	return {$: 'AddToOrigin', a: a};
};
var $author$project$Square$CanvasClick = {$: 'CanvasClick'};
...
var $author$project$Square$width = 900;
var $avh4$elm_color$Color$yellow = A4($avh4$elm_color$Color$RgbaSpace, 237 / 255, 212 / 255, 0 / 255, 1.0);
var $author$project$Square$citeView = F3(
	function (i, j, x) {
		var unit = $author$project$Square$width / $author$project$Square$n;
		return A2(
...
var $author$project$Square$confView = function (conf) {
					...
					function (i, row) {
						return $elm$core$Array$toList(
							A2(
								...
								F2(
									function (j, el) {
										return A3($author$project$Square$citeView, i, j, el);
									}),
								row));
					}),
				conf)));
...
var $author$project$Square$height = 900;
...
var $author$project$Square$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Square$AddToOrigin(1000))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('add to origin 1000')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Square$AddToOrigin(10000))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('add to origin 10000')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A3(
				$joakin$elm_canvas$Canvas$toHtml,
				_Utils_Tuple2($author$project$Square$width, $author$project$Square$height),
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Square$CanvasClick)
					]),
				$author$project$Square$confView(model.conf))
			]));
};
var $author$project$Square$main = $elm$browser$Browser$element(
	{init: $author$project$Square$init, subscriptions: $author$project$Square$subscriptions, update: $author$project$Square$update, view: $author$project$Square$view});
_Platform_export({'Square':{'init':$author$project$Square$main(
